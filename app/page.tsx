                        ...
                        <div className="p-8 flex flex-col items-center text-center relative">
                            ...
                            {checkoutSessionId ? (
                                <div className="w-full h-full flex flex-col gap-6 animate-in fade-in zoom-in duration-500">
                                    <div className="w-full h-[600px] overflow-hidden rounded-[32px] border-4 border-white/5 bg-black/40 shadow-2xl relative">
                                        {checkoutPurchaseUrl ? (
                                            <iframe
                                    ...
                                    <div className="p-6 bg-orange-600/5 border border-white/5 rounded-[32px] flex flex-col justify-center items-center gap-3 backdrop-blur-md">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Having trouble with the secure window?</p>
                                        <a
                                            href={checkoutPurchaseUrl || `https://whop.com/checkout/${checkoutSessionId}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="px-8 py-3 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-tighter hover:bg-slate-100 transition-all flex items-center gap-2 shadow-xl shadow-white/5"
                                        >
                                            <ShoppingBag className="w-4 h-4" />
                                            Complete on Whop.com
                                        </a>
                                    </div>
                                </div>
                            ) : (

                        ...
                        <div className="p-8 flex flex-col items-center text-center relative">
                            ...
                            {checkoutSessionId ? (
                                <div className="w-full flex flex-col gap-4">
                                    <div className="w-full h-[550px] overflow-hidden rounded-2xl border border-white/5 bg-black/20 relative">
                                        <WhopCheckoutEmbed
                                    ...
                                    <div className="p-4 bg-orange-600/10 border border-orange-500/20 rounded-2xl flex flex-col items-center gap-2">
                                        <p className="text-[10px] text-orange-200 font-bold uppercase tracking-widest">Can't see the checkout?</p>
                                        <a
                                            href={checkoutPurchaseUrl || `https://whop.com/checkout/${checkoutSessionId}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="px-6 py-2 bg-orange-600 text-white rounded-full font-black text-[10px] uppercase tracking-tighter hover:bg-orange-500 transition-all flex items-center gap-2"
                                        >
